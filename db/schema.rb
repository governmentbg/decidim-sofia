...
ActiveRecord::Schema.define(version: 2024_11_11_174028) do
  ...
  create_table "decidim_budgets_budgets", id: :serial, force: :cascade do |t|
    ...
    t.integer "vote_selected_projects_maximum"
  ...
  create_table "decidim_users", id: :serial, force: :cascade do |t|
    ...
    t.text "regix_response"
    t.string "regix_status"
    t.datetime "regix_retry_date"
    t.string "region"
    t.integer "scope_id"
