  ...
  module Budgets
    ...
    class Order < Budgets::ApplicationRecord
      ...
      def projects_rule?
        ...
        budget.vote_selected_projects_maximum.to_i > 0 || budget.settings.vote_rule_selected_projects_enabled
      end
      ...
      def maximum_projects
        ...
        if projects_rule?
          budget.vote_selected_projects_maximum || budget.settings.vote_selected_projects_maximum
        else
          0
        end
      end
